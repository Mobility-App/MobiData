...
public final class BikeSharingStation: Codable, Hashable {
    ...
    public init(address: Address? = nil, dataType: DataType? = nil, description: String? = nil, id: String? = nil, imageId: String? = nil, location: Geometry? = nil, name: String? = nil, networkId: String? = nil, operatorId: String? = nil, removed: Bool? = nil, timestamp: Date? = nil, trafficType: TrafficType? = nil, uri: String? = nil, data: DoraData? = nil, booking: ExternalReference? = nil, state: StateType? = nil, bikeCapacity: Int? = nil, bikes: [BikeSharingBike]? = nil, freeBikeCount: Int? = nil) {
        ...
        self.bikes = bikes
        self.freeBikeCount = freeBikeCount
    }
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(bikeCapacity, forKey: .bikeCapacity)
        try container.encodeIfPresent(bikes, forKey: .bikes)
        try container.encodeIfPresent(freeBikeCount, forKey: .freeBikeCount)
    }

    public static func == (lhs: BikeSharingStation, rhs: BikeSharingStation) -> Bool {
        ...
        lhs.state == rhs.state &&
        lhs.bikeCapacity == rhs.bikeCapacity &&
        lhs.bikes == rhs.bikes &&
        lhs.freeBikeCount == rhs.freeBikeCount
    ...
    public func hash(into hasher: inout Hasher) {
        ...
        hasher.combine(bikeCapacity?.hashValue)
        hasher.combine(bikes?.hashValue)
        hasher.combine(freeBikeCount?.hashValue)
